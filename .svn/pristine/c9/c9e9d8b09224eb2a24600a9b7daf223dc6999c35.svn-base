...
import com.safinaz.matrimony.Activities.EditPreferenceActivity;
import com.safinaz.matrimony.Activities.EditProfileActivity;
import com.safinaz.matrimony.Activities.ExclusiveDashboardActivity;
import com.safinaz.matrimony.Activities.GallaryActivity;
...
public class ExclusiveDashboardFragment extends Fragment implements View.OnClickListener, TabHost.OnTabChangeListener {
    ...
    //ImageView img_photo;
    FragmentExclusiveDashboardBinding binding;
    MyData user;
    JSONArray photo_arr;
    ...
    public ExclusiveDashboardFragment() {
        // Required empty public constructor
    }

    public static ExclusiveDashboardFragment newInstance() {
        return new ExclusiveDashboardFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_exclusive_dashboard, container, false);
        view = binding.getRoot();
        //binding.setUser(new MyData());
    ...
    private void initialize() {
        ...
        tv_pro_per = (TextView) view.findViewById(R.id.tv_pro_per);
        tv_basic_label = (TextView) view.findViewById(R.id.tv_basic_label);
    ...
    public void setUserProfile(JSONObject data) {
        try {
            String weight;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.img_edit:
                // gotoEdit("basic");
                Intent i = new Intent(getActivity(), ManagePhotosActivity.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == 7) {
            if (resultCode == RESULT_OK) {
                ...
                if (result.equals("reload") && getActivity()!=null) {
                    ((ExclusiveDashboardActivity) getActivity()).getMyprofile();
                }
                //recreate();
                if (tabid.equals("my")) {
                    host.setCurrentTab(0);
    ...
    private void gotoEditPref(String tag) {
        Intent i = new Intent(getActivity(), EditPreferenceActivity.class);
        i.putExtra("pageTag", tag);
        startActivityForResult(i, 7);
    }
