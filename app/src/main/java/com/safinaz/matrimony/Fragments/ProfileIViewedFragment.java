...
public class ProfileIViewedFragment extends Fragment {
    ...
    public static ProfileIViewedFragment newInstance(String param1, String param2) {
        ProfileIViewedFragment fragment = new ProfileIViewedFragment();
    ...
    private void getListData(int page) {
        ...
        common.makePostRequestTime(Utils.i_viewed_list + page, param, new Response.Listener<String>() {
            @Override
