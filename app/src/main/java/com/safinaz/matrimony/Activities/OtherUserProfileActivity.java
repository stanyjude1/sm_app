...
import com.safinaz.matrimony.OtherUser;
...
import com.safinaz.matrimony.databinding.ActivityOtherUserProfileBinding;
...
public class OtherUserProfileActivity extends AppCompatActivity implements View.OnClickListener, TabHost.OnTabChangeListener {
    ...
    private LinearLayout layoutLocationSection, layoutContactSection;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppDebugLog.print("other_id : " + other_id);
        ...
        layoutContactSection = findViewById(R.id.layoutContactSection);

        layoutLocationSection.setVisibility(View.GONE);
        layoutContactSection.setVisibility(View.GONE);
    ...
    private void getMyProfile() {
        ...
        common.makePostRequest(Utils.other_user_profile, param, response -> {
            ...
            try {
                ...
                if (object.getString("status").equals("success")) {
                    ...
                    if (session.getLoginData(SessionManager.USER_TYPE) != null
                            ...
                            && session.getLoginData(SessionManager.USER_TYPE).equalsIgnoreCase("o")
                            && data.has("user_type")
                            && "o".equalsIgnoreCase(data.getString("user_type"))) {
                        layoutLocationSection.setVisibility(View.VISIBLE);
                        layoutContactSection.setVisibility(View.VISIBLE);
                    }else{
                        layoutLocationSection.setVisibility(View.GONE);
                        layoutContactSection.setVisibility(View.GONE);
                    }
