...
import com.safinaz.matrimony.Custom.NonScrollListView;
import com.safinaz.matrimony.Model.paymentItem;
...
public class MakePaymentsActivity extends AppCompatActivity {
    ...
    private void getPaymentMethod() {
        ...
        common.makePostRequest(Utils.get_payment_method, new HashMap<String, String>(), response -> {
            pd.dismiss();
    ...
    public class MethodAdapter extends ArrayAdapter<paymentItem> {
        ...
        public View getView(final int position, View view, ViewGroup parent) {
            ...
            AppDebugLog.print("item.getLogo() : " + item.getLogo());
