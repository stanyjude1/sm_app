            ...
            if (b.containsKey("pageTag")) {
                ...
                switch (pageTag) {
                    ...
                    case KEY_RELIGION:
                        ...
                        toolbar.setTitle("Religious Information");
                        break;
                    case KEY_PROFILE:
                        lay_about.setVisibility(View.VISIBLE);
                        toolbar.setTitle("About Us & Hobbies and Interests");
                        break;
                    case KEY_EDUCATION:
        ...
        if (MyApplication.getSpinData() != null) {
            switch (pageTag) {
                case KEY_BASIC:
                    ...
                    tot_list_id = common.getListFromArray_id(MyApplication.getSpinData().getJSONArray("total_children"), "Number of children");
                    ...
                    List<String> tong_val = common.getListFromArray(MyApplication.getSpinData().getJSONArray("mothertongue_list"), "Language Known");
                ...
                case KEY_LOCATION:
                    ...
                    break;
                case KEY_FAMILY:
                    spin_family_type = findViewById(R.id.spin_family_type);//family_type
